...
import { PAYMENT_STATUS, RENEW_STATUS, SUBSCRIPTION_STATUS, SUBSCRIPTION_TYPE } from './subscription.constants'
...
const SubscriptionsSchema = new Schema<TSubscriptions>(
  {
    ...
    package: { type: Schema.Types.ObjectId, ref: 'Package', required: true },
      type: { type: String, enum: Object.values(SUBSCRIPTION_TYPE), required: true },
    ...
    autoRenew: { type: String,  enum: Object.values(RENEW_STATUS),
